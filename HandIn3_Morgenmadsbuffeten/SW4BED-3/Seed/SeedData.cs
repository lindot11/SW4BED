		...
		public static void SeedReservations(IServiceProvider serviceProvider)
		{
			using (var context = new DataDB(serviceProvider.GetRequiredService<DbContextOptions<DataDB>>()))
			{
				...
				context.Reservations.AddRange(
					new Reservations { RoomNumber = 1, AdultsReservations = 2, KidsReservations = 2, AdultsCheckIn = 2, KidsCheckIn = 2, Date = DateTime.Today },
					new Reservations { RoomNumber = 2, AdultsReservations = 2, KidsReservations = 2, AdultsCheckIn = 0, KidsCheckIn = 0, Date = DateTime.Today },
					new Reservations { RoomNumber = 3, AdultsReservations = 2, KidsReservations = 2, AdultsCheckIn = 0, KidsCheckIn = 0, Date = DateTime.Today },
					new Reservations { RoomNumber = 4, AdultsReservations = 2, KidsReservations = 2, AdultsCheckIn = 0, KidsCheckIn = 0, Date = DateTime.Today },
					new Reservations { RoomNumber = 5, AdultsReservations = 2, KidsReservations = 2, AdultsCheckIn = 0, KidsCheckIn = 0, Date = DateTime.Today});
